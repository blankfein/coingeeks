...
image_path = File.join(Rails.root, "app/assets/images/sample/pic/pic007.jpg")
TopPageDiscoveryImage.seed do |obj|
  obj.id = 3
  obj.order_num = 3
  obj.image = File.new(image_path)
  obj.tagline_ja = "台湾"
  obj.tagline_en = "Taiwan"
#  obj.tagline_zh_cn = "台湾"
  obj.link_url = "http://airbnb-clones.herokuapp.com"
  obj.size = 1
  obj.show_price = true
  obj.listing_id = 1
end

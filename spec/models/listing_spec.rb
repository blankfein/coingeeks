...
describe Listing do
  ...
  describe '#set_lon_lat' do
    ...
    it 'sets correct latitude and longitude to self', unless: @api_status == "OVER_QUERY_LIMIT" do
      expect(listing.latitude.to_i).to eq 42
      expect(listing.longitude.to_i).to eq 141
    end

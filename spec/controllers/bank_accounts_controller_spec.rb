...
RSpec.describe BankAccountsController, type: :controller do
  ...
  describe 'GET #show' do
    before { FactoryGirl.create(:bank_account, profile: @user.profile) }
  ...
  describe 'POST #create' do
    context 'with valid attributes' do
      it 'saves the new bank account to the database' do
        expect {
          post :create,
            bank_account: FactoryGirl.attributes_for(:bank_account, profile: @user.profile)
    ...
    context 'with invalid attributes' do
      it 'does not save the new bank account in the database' do
        expect {
          post :create,
            bank_account: FactoryGirl.attributes_for(:invalid_bank_account, profile: @user.profile)

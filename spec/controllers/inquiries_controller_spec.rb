    ...
    describe 'POST #confirm' do
      context 'with valid attributes' do
        it 'renders the :confirm template' do
          post :confirm, inquiry: FactoryGirl.attributes_for(:inquiry)
      ...
      context 'with invalid attributes' do
        it 're-renders the :new template' do
          post :confirm, inquiry: FactoryGirl.attributes_for(:invalid_inquiry)
          expect(response).to render_template :new
        end
      end
    end
    ...
    describe 'POST #create' do
      ...
      context 'with invalid attributes' do
        it 'does not save the new inquiry in the database' do
          expect {
            post :create,
            inquiry: FactoryGirl.attributes_for(:invalid_inquiry)
